...
class Header extends Component {
    ...
    oppenSlideOut = ()=> {
        ...
        slideOut.classList.add('showSlide');
        let header = document.querySelector('.navbar');
        header.onclick = function(event) {
            if (event.target !== slideOut) {
                slideOut.classList.remove('showSlide');
            }
        }
    }
        ...
        <header>
              ...
              <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                  ...
                  <div className="float-left">
                      <a data-activates="slide-out" className="button-collapse" href="#1" onClick={this.oppenSlideOut}>
                  ...
                  <ul className="nav navbar-nav nav-flex-icons ml-auto">
                      <li className="nav-item dropdown">
                          <a className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" 
                            data-toggle="dropdown"  aria-expanded="false" href="#1">
